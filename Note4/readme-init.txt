# index of triplr-dev group repo directories we build for note 4
# init scripts are in each sub dir 
...
# Pixel Plus		repo init --depth=1 -u https://github.com/PixelExperience/manifest -b pie-plus
# Pixel Exp 10 		repo init --depth=1 -u https://github.com/PixelExperience/manifest -b ten
